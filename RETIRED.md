...
| `deploy/CD-UNBLOCK-2026-09-15.md` | **Archived 2026-09-17** (Wave 4, 13-9): dated incident record, kept for history with an archive header. Live CD-approval procedure: `deploy/PRODUCTION-OPERATOR-RUNBOOK.md`. |
| `deploy/PRODUCTION-READINESS-2026-09-07.md` | **Archived 2026-09-17** (Wave 4, 13-9): dated point-in-time review. Live procedure: `deploy/PRODUCTION-OPERATOR-RUNBOOK.md`. |
| `deploy/RECOVERED-LIVE-SNAPSHOT.md` | **Archived 2026-09-17** (Wave 4, 13-9): dated 2026-07-13 recovery evidence. Live procedures: `deploy/PRODUCTION-OPERATOR-RUNBOOK.md`. |
