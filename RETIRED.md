...
Live system: `CLAUDE.md` + `AGENTS.md`. The paths below are retired or
...
| `HANDOVER/` | Onboarding docs dated 2026-07-13, before the Fable port. Claims like "webhook/processor source is not in the repo" are outdated. Trust order: `CLAUDE.md` ≈ `AGENTS.md` → `HANDOVER/` → dated plans. Superseded: `INCONSISTENCIES.md`, `DEV-ISSUES.md`. Stale layout: root `README.md`. |
