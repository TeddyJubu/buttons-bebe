...
from hermes_runner import _build_prompt  # noqa: E402


class HermesReadOnlyPromptTests(unittest.TestCase):
    def test_deprecated_write_flag_cannot_enable_autonomous_gorgias_writes(self) -> None:
