...
def _build_prompt(
    ...
    return (
        ...
        "and trade-show mail are LOW with action no_kb_match and draft 'No "
        "reply needed — [brief reason]'. Never tag them sensitive and never "
        "notify the owner.\n"
        "  A plain thank-you / acknowledgment ('thanks', 'got it', thumbs-up) "
        "with no new question is LOW with action drafted and a 1-sentence "
        "reply ('You're welcome, [name]!'). Never prefix it [SENSITIVE] and "
        ...
        "draft — that wording belongs, at most, in the AGENT NOTE after "
        "JSON_RESULT. Staff routing belongs in AGENT NOTE, without claiming "
        ...
        "team can look into it?' Put the review needed in the AGENT NOTE, "
